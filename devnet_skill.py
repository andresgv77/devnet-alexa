...
def get_welcome_response():
    ...
    speech_output = "Bienvenido a la Habilidad DevNet Alexa para la Gestión de UCS." \
                    "Se puede hacer preguntas como: ¿Cuál es el total de fallas?" \
...
# Crear y asociar un Service Profile a un servidor disponible
...
def on_intent(intent_request, session):
    ...
    if intent_name == "ObtenerFallas":     # Entry point for the GetFaults intent that you created
        return get_faults(intent, session)
    elif intent_name == "AgregarVlan":         # Entry point for the AddVlan intent that you created
        return add_vlan(intent, session)
    elif intent_name == "EliminarVlan":      # Entry point for the RemoveVlan intent that you may have created :)
        return remove_vlan(intent, session)
    elif intent_name == "AprovisionarServidor": # Entry point for the ProvisionServer intent that you created
        ...
        raise ValueError("Intento no valido")
